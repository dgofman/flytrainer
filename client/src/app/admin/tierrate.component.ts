...
export class TierRateComponent extends AppBaseDirective {
  ...
  cols: ColumnType[] = [
    ...
    { field: 'rate', type: 'number', show: true, header: Locales.rate, width: 100, maxlen: 2, class: 'inlineL' },
    ...
    { field: 'minRate', type: 'number', header: Locales.minRate, width: 100, maxlen: 2, class: 'inlineL' },
    { field: 'maxRate', type: 'number', header: Locales.maxRate, width: 100, maxlen: 2, class: 'inlineR' },
