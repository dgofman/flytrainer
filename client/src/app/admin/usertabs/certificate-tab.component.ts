...
export class CertificateTabComponent extends UserTabBaseDirective implements OnInit {
    ...
    constructor(confirmationService: ConfirmationService, private adminService: AdminService, private formBuilder: FormBuilder) {
        ...
        this.controls = [
            ...
            { field: 'number', header: Locales.certificate_num, type: 'input', maxlen: 10, validators: [Validators.required], class: 'inlineL' },
            { field: 'limitations', header: Locales.limitations, type: 'input', maxlen: 100, class: 'inlineR' },
